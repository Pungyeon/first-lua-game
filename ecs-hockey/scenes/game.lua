...
function Game:init()
	...
	entities = {
		...
		Player:new(center_x + player_width * 6, center_y - player_width / 2, red_team),
		...
		Wall:new(home_goal_position.x, home_goal_position.y + goal_height - post_thickness, goal_width, post_thickness),
		-- Away Team Goal
